...
public class SecurityConfig {
    ...
    // React CMS (Vite, dev server mặc định port 5173) gọi API qua origin khác
    // (khác port = khác origin với trình duyệt) — không có CORS thì mọi request
    // bị browser chặn trước khi tới được Spring, kể cả endpoint permitAll().
    @Bean
